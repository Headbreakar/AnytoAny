...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full border-t border-white/5 bg-bg-dark/50 backdrop-blur-sm mt-auto">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            <h3 className="font-display text-xs font-semibold text-white tracking-widest uppercase mb-4">
              Conversions
            </h3>
