  ...
  return (
    <div className="w-full space-y-3">
      <div className="flex items-center justify-between text-sm">
        <span className="font-medium text-slate-300">{label || "Processing..."}</span>
        <span className="font-bold tabular-nums text-primary">{Math.round(clampedProgress)}%</span>
      </div>
      <div className="relative h-3 w-full overflow-hidden rounded-full bg-slate-800/80 border border-white/5">
        <div
